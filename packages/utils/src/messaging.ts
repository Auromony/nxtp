...
export const NATS_AUTH_URL_TESTNET = NATS_AUTH_URL_LOCAL;
export const NATS_WS_URL_TESTNET = NATS_WS_URL_LOCAL;
export const NATS_CLUSTER_URL_TESTNET = NATS_CLUSTER_URL_LOCAL;
