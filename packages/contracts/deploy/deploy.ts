...
const TEST_ROUTERS = [
  ...
  "0xf80e98359eb8d9aaF4DAB0938624f9C5c3AE0c81", // auromony dev router
];

const SKIP_SETUP = [
  1, 10, 25, 56, 250, 288, 137, 100, 122, 1285, 9001, 42161, 43114, 1284, 2001, 192837465, 1313161554, 1313161555, 1666600000, 1666700000, 
];
...
WRAPPED_ETH_MAP.set("1313161554", "0xC9BdeEd33CD01541e1eeD10f90519d2C06Fe3feB"); // aurora WETH
WRAPPED_ETH_MAP.set("1313161555", "0xC9BdeEd33CD01541e1eeD10f90519d2C06Fe3feB"); // aurora testnet WETH
WRAPPED_ETH_MAP.set("1666600000", "0xcf664087a5bb0237a0bad6742852ec6c8d69a27a"); // harmony WONE
